...
# ── YOUR CONFIG ──────────────────────────────────────────────────
OPENROUTER_API_KEY = "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"
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .result-header {
      background: #1a56db; border-radius: 12px;
    ...
    .summary-box {
      ...
      font-size: 13px; color: #1e40af; margin-bottom: 1rem; line-height: 1.5;
    }
        ...
        if mode == "text":
            ...
            messages = [{
                ...
                "content": [
                    {
                        "type": "image_url",
                        "image_url": { "url": f"data:{file_type};base64,{file_b64}" }
                    },
...
if __name__ == "__main__":
    print("\n" + "="*50)
    print("  Invoice Extractor running!")
